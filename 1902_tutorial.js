//http://conceptf1.blogspot.de/2013/11/javascript-closures.html działa fajnie, dzisiaj dokończenie pętli
...
describe('x', function() {
    ...
    it('y', function() {
        var myFunctions = [];
        var godzina_1 = element.all(by.xpath('//*[@id="wx-main"]/div[1]/article/div/div/div/div/div[2]/div[2]/a/div/section/div/h2/span')).first();
        var godzina_text_1 = godzina_1.getText();
        godzina_text_1.then(function(text) {
            console.log(text);
            minuta_1 = parseFloat(text.substring(3,5));
        });
        function createMyFunction(i) {
            return function() {
